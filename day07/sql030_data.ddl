...
ALTER TABLE NewBook
	ADD CONSTRAINT R_5 FOREIGN KEY (pubname) REFERENCES NewPublisher(pubname)
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
go
...
BEGIN
  DECLARE  @errno   int,
    ...
    /* ERWIN_RELATION:CHECKSUM="000213d4", PARENT_OWNER="", PARENT_TABLE="NewBook"
    ...
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_5", FK_COLUMNS="pubname" */
...
BEGIN
  ...
  /* ERWIN_RELATION:CHECKSUM="00027158", PARENT_OWNER="", PARENT_TABLE="NewBook"
    CHILD_OWNER="", CHILD_TABLE="NewOrder"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_6", FK_COLUMNS="bookid" */
  IF
...
BEGIN
  DECLARE  @errno   int,
    ...
    /* ERWIN_RELATION:CHECKSUM="0000f191", PARENT_OWNER="", PARENT_TABLE="NewPublisher"
    CHILD_OWNER="", CHILD_TABLE="NewBook"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_5", FK_COLUMNS="pubname" */
    IF EXISTS (
...
BEGIN
  ...
  /* ERWIN_RELATION:CHECKSUM="00010c7b", PARENT_OWNER="", PARENT_TABLE="NewPublisher"
    CHILD_OWNER="", CHILD_TABLE="NewBook"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_5", FK_COLUMNS="pubname" */
  IF
